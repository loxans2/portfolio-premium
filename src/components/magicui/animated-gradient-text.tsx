...
export default function AnimatedGradientText({
  ...
  return (
    <div
      className={cn(
        "group relative mx-auto flex max-w-fit flex-row items-center justify-center rounded-full px-4 py-1.5 text-sm font-medium shadow-[inset_0_-8px_10px_#fbbf2440] backdrop-blur-sm transition-shadow duration-500 ease-out [--bg-size:300%] hover:shadow-[inset_0_-5px_10px_#fbbf2480]",
        className,
      )}
    >
      <div
